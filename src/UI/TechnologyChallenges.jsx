...
const TechnologyChallenges = () => {
  ...
  return (
    <div className="relative">
      ...
      <div
        className="absolute inset-0 bg-[#1D1B28] bg-opacity-80 flex flex-col items-center 
      justify-center text-white"
      >
        <p className="text-xl md:text-xl text-[#3C72FC]">What we Solve</p>
        <p className="text-4xl md:text-4xl font-bold py-12">
