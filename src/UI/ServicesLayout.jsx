      ...
      <div className="flex-col  service flex  w-[100%]  lg:flex-row lg:w-[80%]  mx-auto lg:gap-20  2xl:gap-28 py-32">
        <div className="w-[90%] lg:w-[40%] mx-auto  ">
          <div className="flex flex-col lg:flex-col gap-20">
            {/* left  */}
            <div className="bg-white shadow-2xl  p-4  w-full mx-auto">
              <div className="font-semibold text-2xl pl-6">Services</div>
              {/* // yahan se  */}
              <div className="relative font-medium w-full overflow-hidden mt-8">
                ...
                <div className="overflow-hidden font-medium transition-all duration-500 max-h-0 peer-checked:max-h-56">
              ...
              {/* yahan tak  */}
              {/* // yahan se  */}
              <div className="relative font-medium w-full overflow-hidden ">
                <ul className="peer absolute top-0 inset-x-0 w-full h-12 opacity-0 z-10 cursor-pointer"></ul>
                <input
                  type="checkbox"
              ...
              {/* yahan tak  */}
              {/* // yahan se  */}
              <div className="relative w-full font-medium overflow-hidden ">
                <ul className="peer absolute top-0 inset-x-0 w-full h-12 opacity-0 z-10 cursor-pointer"></ul>
                <input
                  type="checkbox"
                  className="peer absolute top-0 inset-x-0 w-full h-12 opacity-0 z-10 cursor-pointer bg-blue-100"
              ...
              <NavLink
                to="UXDesigner"
                className="flex justify-between font-medium items-center  hover:bg-blue-secondary hover:text-white p-4"
              >
                UI/UX Designing
              ...
              <NavLink
                ...
                className="flex justify-between font-medium capitalize items-center  hover:bg-blue-secondary hover:text-white p-4 "
              >
                Off Shore/On Shore
                <AiOutlineArrowRight className="text-lg" />
              </NavLink>
            ...
            {/* right  */}
            <div className="bg-blue-secondary text-white p-4 w-full  space-y-12">
